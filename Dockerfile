...
LABEL \
	...
	org.label-schema.name="elk7" \
	org.label-schema.description="Docker version of Elasticsearch, Logstash and Kibana 7 based on Alpine Linux" \
	org.label-schema.version="${VERSION}" \
	org.label-schema.vcs-url="https://github.com/githubcdr/docker-elk7" \
